...
function login() {
    return location.href = "http://localhost:8030/page/showLogin";
}
function regist() {
    return location.href = "http://localhost:8030/page/register";
}
...
function search(a) {
    var b = "http://localhost:8050/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
