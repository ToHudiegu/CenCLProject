...
<body id="mainframe">
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/taotao-logo.gif" alt="CenCL商城"></a>
		</div>
	</div>
...
#refresh .m .fore4 a {
	...
	font-size: 12px
			...
			<ul class="m">
				<li class="fore1">您可以：稍后再试或联系客服（0769）86211555。
				</li>
				<li class="fore2">返回<a href="/" target="_blank">CenCL首页</a></li>
