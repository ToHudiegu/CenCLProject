...
<!-- ${query} 查询条件，需要回显 -->
<title>${query} - 商品搜索 - CenCL</title>
<meta name="Keywords" content="java,java" />
<meta name="description" content="在CenCL中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<!-- 由于使用jstl表达式遍历，所以JSON数据需要先转换成java对象 -->
...
<li class="item-book" bookid="11078102">
	...
	<div class="service">由 CenCL 发货</div>
	<div class="extra">
