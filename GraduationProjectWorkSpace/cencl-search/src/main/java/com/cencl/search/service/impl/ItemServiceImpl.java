package com.cencl.search.service.impl;
...
import com.cencl.search.mapper.ItemMapper;
import com.cencl.search.pojo.Item;
...
public class ItemServiceImpl  implements ItemService{
	...
	//从数据库中查询所有商品数据，创建solrInputDocument对象，把对象写入索引库
